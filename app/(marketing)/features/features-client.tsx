      ...
      <section className="ld-alt" style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="ld-wrap">
          ...
          <FeatureRow
            ...
            paragraph={t('Sprout Track speaks thirteen languages, and every caretaker picks their own. Mom logs in English, oma logs in Deutsch. Same timeline, same entries.')}
